...
//
//            foreach ($setting_options as $com_option) {
//                createOrUpdateTranslationJson($request, $com_option->id, 'App\Models\SettingOption', [$com_option->option_name]);
//            }
//
...
//    }
    public function footerCustomization(Request $request)
    {
        if ($request->isMethod('POST')) {
            ...
            $setting_option = SettingOption::updateOrCreate(
            ...
            createOrUpdateTranslationJson($request, $setting_option->id, 'App\Models\SettingOption', $translationKeys);
