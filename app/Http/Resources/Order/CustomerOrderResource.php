...
class CustomerOrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'coupon_disc_amt_admin' => $this->coupon_disc_amt_admin,
            'coupon_disc_amt_store' => $this->coupon_disc_amt_store,
            'product_disc_amt' => $this->product_disc_amt,
            'flash_disc_amt_admin' => $this->flash_disc_amt_admin,
            'flash_disc_amt_store' => $this->flash_disc_amt_store,
