...
class SettingOption extends Model
{
    ...
    public $translationKeys = [
        ...
        'com_register_page_title', 'com_register_page_subtitle', 'com_register_page_description', 'com_register_page_terms_title','com_login_page_title','com_login_page_subtitle',
    ];
